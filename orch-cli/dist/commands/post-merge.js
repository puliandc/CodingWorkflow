...
async function run(args) {
    ...
    try {
        ...
        process.stderr.write(`❌ 交付后核验失败：${err.message}\n`);
        process.exit(1);
    }
    ...
    try {
        ...
        const gateResultRaw = (0, node_child_process_1.execFileSync)('node', [(0, node_path_1.resolve)(__dirname, '..', 'index.js'), 'gate'], { encoding: 'utf8' });
